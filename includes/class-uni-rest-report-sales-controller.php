...
class Uni_Rest_Sales_Controller extends Uni_REST_Posts_Controller {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! wc_rest_check_manager_permissions( 'reports', 'read' ) ) {
			return new WP_Error( 'uni_wc_order_app_rest_cannot_view', __( 'Sorry, you cannot list resources.', 'wc-orders-app' ), array( 'status' => rest_authorization_required_code() ) );
		}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'total_sales' => array(
					'description' => __( 'Gross sales in the period.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'net_sales' => array(
					'description' => __( 'Net sales in the period.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'average_sales' => array(
					'description' => __( 'Average net daily sales.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_orders' => array(
					'description' => __( 'Total of orders placed.', 'wc-orders-app' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_items' => array(
					'description' => __( 'Total of items purchased.', 'wc-orders-app' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_tax' => array(
					'description' => __( 'Total charged for taxes.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_shipping' => array(
					'description' => __( 'Total charged for shipping.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_refunds' => array(
					'description' => __( 'Total of refunded orders.', 'wc-orders-app' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_discount' => array(
					'description' => __( 'Total of coupons used.', 'wc-orders-app' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'totals_grouped_by' => array(
					'description' => __( 'Group type.', 'wc-orders-app' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'totals' => array(
					'description' => __( 'Totals.', 'wc-orders-app' ),
					'type'        => 'array',
					'items'       => array(
						'type'    => 'array',
					),
	...
	public function get_collection_params() {
		return array(
			...
			'period' => array(
				'description'       => __( 'Report period.', 'wc-orders-app' ),
				'type'              => 'string',
